...
public class Cliente {
    ...
    private Long fatturazioneClienteId;
    ...
    public void setCodiceCliente(int codiceCliente) { this.codiceCliente = codiceCliente; }
    ...
    public Long getFatturazioneClienteId() { return fatturazioneClienteId; }
    public void setFatturazioneClienteId(Long fatturazioneClienteId) { this.fatturazioneClienteId = fatturazioneClienteId; }
    ...
    public String toString() {
        String cod = String.format("%06d", codiceCliente);
