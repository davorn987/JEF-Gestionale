...
public class AttributoCategoriaEditDialog extends JDialog {
    ...
    private final AttributoCategoria categoria;

    public AttributoCategoriaEditDialog(JFrame owner, String title, AttributoCategoria categoriaToEditOrNull) {
        super(owner, title, true);

        if (categoriaToEditOrNull != null) {
            this.categoria = cloneAttributoCategoria(categoriaToEditOrNull);
        } else {
            this.categoria = new AttributoCategoria();
    ...
    public AttributoCategoria getAttributoCategoria() { return categoria; }

    private static AttributoCategoria cloneAttributoCategoria(AttributoCategoria ac) {
        AttributoCategoria clone = new AttributoCategoria();
        clone.setId(ac.getId());
        clone.setCodice(ac.getCodice());
        clone.setDescrizione(ac.getDescrizione());
        clone.setAttivo(ac.isAttivo());
        return clone;
    }
}
